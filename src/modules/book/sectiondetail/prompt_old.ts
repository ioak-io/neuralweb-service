  ...
  messages: [
    {
      ...
      content: [
        ...
        "Use <p> for paragraphs, <i> for emphasis, <b> only when necessary. Do not use <b> (bold) in the content field, as the title is already provided in the title field.",
        "Ensure the output is valid JSON with all strings, property names, and values properly enclosed in double quotes.",
        "Structure the output as follows: [{'title': 'Subtitle for the first subsection', 'content': 'Set of paragraphs in HTML with <p> and <i> tags'}, {'title': 'Subtitle for the next subsection', 'content': 'Set of paragraphs in HTML with <p> and <i> tags'}, {...}]",
        ...
        "Do not prefix or repeat the section title inside the content field, and avoid redundant bold headings within the content.",
      ],
    },
    {
      role: "user",
      content: [
        ...
        "Provide a detailed explanation of this section using only <p> and <i> tags for formatting in the output, without using any <b> tags.",
  ...
  messages: [
    {
      ...
      content: [
        ...
        "Limit the use of HTML tags to just <b>, <i>, and bullets, and ensure the content remains fully readable.",
    ...
    },
    {
      ...
      content: [
        ...
        "Ensure all property names and values are double-quoted, and the output is fully JSON compliant with correct formatting.",
        "Limit HTML tags in the explanation to <b>, <i>, and bullet points for emphasis, and do not add unnecessary commentary or explanations.",
      ],
    },
  ],
  temperature: 1,
