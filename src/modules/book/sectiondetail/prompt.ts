  ...
  messages: [
    {
      ...
      content: [
        ...
        "Double-check for any missing commas, brackets, or other formatting issues before finalizing the output.",
        "Ensure the JSON structure is strictly followed as outlined: [{'title': 'Subtitle for the first subsection', 'content': 'Set of paragraphs in HTML with <p> and <i> tags'}, {'title': 'Subtitle for the next subsection', 'content': 'Set of paragraphs in HTML with <p> and <i> tags'}, {...}]",
    ...
    },
    {
      ...
      content: [
        ...
        "Check the JSON structure carefully for any missing commas, extra characters, or incorrect brackets.",
      ],
    },
  ],
  temperature: 1,
